...
func (in *ChallengeSecretRef) DeepCopyInto(out *ChallengeSecretRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChallengeSecretRef.
func (in *ChallengeSecretRef) DeepCopy() *ChallengeSecretRef {
	if in == nil {
		return nil
	}
	out := new(ChallengeSecretRef)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DelegatedSignerConfiguration) DeepCopyInto(out *DelegatedSignerConfiguration) {
	*out = *in
	if in.DNSNames != nil {
	...
	if in.RenewalWindow != nil {
		in, out := &in.RenewalWindow, &out.RenewalWindow
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DelegatedSignerConfiguration.
func (in *DelegatedSignerConfiguration) DeepCopy() *DelegatedSignerConfiguration {
	if in == nil {
		return nil
	}
	out := new(DelegatedSignerConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IssuerSpec) DeepCopyInto(out *IssuerSpec) {
	*out = *in
	if in.ChallengeSecretRef != nil {
		in, out := &in.ChallengeSecretRef, &out.ChallengeSecretRef
		*out = new(ChallengeSecretRef)
		**out = **in
	}
	if in.DelegatedSignerConfiguration != nil {
		in, out := &in.DelegatedSignerConfiguration, &out.DelegatedSignerConfiguration
		*out = new(DelegatedSignerConfiguration)
		(*in).DeepCopyInto(*out)
	}
	if in.DelegatedSignerSecretName != nil {
		in, out := &in.DelegatedSignerSecretName, &out.DelegatedSignerSecretName
		*out = new(string)
		**out = **in
	}
}
